...
test("an org that moves its digest day mid-week does not double-report the overlap", async () => {
...
test("a later run of the same due day cannot re-summarise it", async () => {
