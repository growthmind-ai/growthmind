...
describe("evidenceForAgent", () => {
  const evidence: EvidenceView = {
    ...
    beats: [
      ...
      { index: 1, at: "00:11", kind: "network", text: "POST /api/team/invite failed", notable: true, attempt: null },
      { index: 2, at: "00:19", kind: "click", text: 'clicked "Send invite"', notable: false, attempt: 2 },
    ],
