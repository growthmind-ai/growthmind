/**
 * The Growthmind brand palette — the one place a brand colour is written down
 * in this app. Mirrors the marketing site's palette (growthmind.ai) so the app
 ...
 *
 * Components never reference these hexes directly — they consume Mantine's
 * semantic tokens (see the theme), so a re-skin is an edit here, not a sweep
