...
import type { AgentView, PlanView, VerdictView } from "./types";
...
//
// What is left is the two surfaces with no producer — /plan waits on O-033's brief-time
// exchange, /experiments on O-028 and O-034 — plus the pack half of /agent, which O-032 owns.
