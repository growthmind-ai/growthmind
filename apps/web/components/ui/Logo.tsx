...
/**
 * The double-chevron mark: forward chevron in ink, trailing chevron in the band colour.
 *
 * Decorative by default, beside the wordmark it says nothing a screen reader doesn't
 * already get from the text, so it is `aria-hidden`. Pass `label` where the mark stands
 * alone and *is* the meaning; that promotes the svg itself to `role="img"`, which is
 * what the accessibility tree expects for inline svg.
 */
